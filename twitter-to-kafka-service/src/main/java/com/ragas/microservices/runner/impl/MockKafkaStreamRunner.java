...
import com.ragas.microservices.exception.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public void start() throws TwitterException {
        final String[] keywords = twitterToKafkaServiceConfiguration.getTwitterKeywords().toArray(new String[0]);
